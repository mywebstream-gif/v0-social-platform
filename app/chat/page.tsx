...
import { Brain, MessageCircle, Users, Sparkles } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Connect with your matches and get AI-powered conversation guidance</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="border-border/50">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-muted-foreground">AI Coaching Tips Used</div>
            </CardContent>
          </Card>
          <Card className="border-border/50">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-muted-foreground">Connections This Week</div>
            </CardContent>
          </Card>
        </div>
